...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Arses Panel · codebox</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="modal-bg" id="modal-support-dev" style="z-index:9999">
  <div class="modal-v2" style="max-width:440px">
    ...
    <div class="modal-v2-body">
      <div class="sdev-grid">
        <a href="https://github.com/arvin341az-glitch/Arses" target="_blank" rel="noopener" class="sdev-card">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">codebox</div><div class="logo-sub">Arses Panel · v9.2</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">codebox Arses Panel v9.2 · Railway · 2025</span>
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      ...
      <div><div class="brand-name">codebox</div><div class="brand-sub">Arses Panel · v9.2</div></div>
    </div>
  ...
  <div class="footer">کانال رسمی: <a href="https://t.me/CodeBoxo" target="_blank">@CodeBoxo</a> · Arses Panel v9.2</div>
</div>
<script>
